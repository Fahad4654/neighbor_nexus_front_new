...
function ResetPasswordOtpComponent() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      router.push(`/set-new-password?identifier=${identifier}`);
    } catch (error: any) {
    ...
    <div className="flex items-center justify-center min-h-screen bg-background p-4 sm:p-6 lg:p-8">
      <Card className="w-full max-w-sm mx-auto">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-headline">Verify Reset Code</CardTitle>
          <CardDescription>
            Enter the OTP sent to {identifier ? <strong>{identifier}</strong> : "your account"}.
          </CardDescription>
        </CardHeader>
        <CardContent>
